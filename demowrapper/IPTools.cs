...
namespace wrappers {
	public class IPTools
	{
		...
		*/
		...
		{
			maglev.maglev.MagLevOld mybus = maglev.maglev.MagLevOld.getInstance("default");
			object[] args = [string subnet_mask];
			object ret;
			MyCallbackDelegate async_delegate = delegate (object async_ret) { ret = async_ret; };
			global::haxe.lang.Function async_callback = maglev.MagLevCs.callbackDelegateToHaxeFunction(async_delegate);
